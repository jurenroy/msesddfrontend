        ...
        <div className="a4-container">
            {trackingData && (
                <div className="tracking-content">
                    ...
                    <div className="single-row">
                        <p>2. Post Office Address :</p>
                        <p>{trackingData.address}</p>
                    </div>
                    <div className="single-row">
                        <p style={{marginLeft: '20px'}}>Contact No. :</p>
                        <p>{trackingData.contactNo}</p>
                    </div>

                    <div className="single-row2">
                        <p style={{fontWeight: 'bold'}}>3. Age : <span style={{fontWeight: 'normal'}}>{trackingData.age}</span></p>
                        <p style={{fontWeight: 'bold'}}>Civil Status : <span style={{fontWeight: 'normal'}}>{trackingData.civilStatus}</span></p>
                    </div>

                    <div className="single-row2">
                        <p style={{fontWeight: 'bold'}}>4. Date of Birth : <span style={{fontWeight: 'normal'}}>{trackingData.dateOfBirth}</span></p>
                        <p style={{fontWeight: 'bold'}}>Place of Birth : <span style={{fontWeight: 'normal'}}>{trackingData.placeOfBirth}</span></p>
                    </div>

                    <div className="single-row2">
                        <p style={{fontWeight: 'bold'}}>5. Citizenship : <span style={{fontWeight: 'normal'}}>{trackingData.citizenship}</span></p>
                        <p style={{fontWeight: 'bold'}}>How Acquired : <span style={{fontWeight: 'normal'}}>{trackingData.howAcquired}</span></p>
                    </div>


                    <div className="single-row full-span">
                    ...
                    {trackingData.citizenship.toLowerCase() !== 'filipino' && (
                        <div>
                            <p style={{fontWeight: 'bold', marginBottom: '-20px'}}>6. If Alien:</p>
                            <p style={{marginLeft: '20px', fontWeight: 'bold', marginBottom: '-20px' }}>Last residence before coming to the Philippines : <span style={{fontWeight: 'normal', marginLeft: '20px'}}>{trackingData.lastResidence}</span></p>
                            <p style={{marginLeft: '20px', fontWeight: 'bold', marginBottom: '-20px' }}>Date of arrival in the Philippines : <span style={{fontWeight: 'normal', marginLeft: '20px'}}>{trackingData.dateOfArrival}</span></p>
                            <p style={{marginLeft: '20px', fontWeight: 'bold', marginBottom: '-20px' }}>Landing Certificate No. : <span style={{fontWeight: 'normal', marginLeft: '20px'}}>{trackingData.landingCertificateNo}</span></p>
                            <p style={{marginLeft: '20px', fontWeight: 'bold', marginBottom: '-20px' }}>Did you come on contract of employment? : <span style={{fontWeight: 'normal', marginLeft: '20px'}}>{trackingData.employmentContract}</span></p>
                            <p style={{marginLeft: '20px', fontWeight: 'bold', marginBottom: '-20px' }}>If so, state nature of employment and : <span style={{fontWeight: 'normal', marginLeft: '20px'}}>{trackingData.employmentNature}</span></p>
                    ...
                    <div>
                        <p style={{fontWeight: 'bold', marginBottom: '-20px', marginTop: '-0px'}}>7. Present Employment :</p>
                    ...
                    <div style={{fontSize: '13px'}}>
                        ...
                        <div className="single-row full-span">
                            <p style={{marginRight: '20px', marginBottom: '20px', fontWeight: 'normal'}}>Very respectfully yours,</p>
                        ...
                        <p style={{marginBottom: '-20px'}}>Doc. No.	____________</p>
                        <p style={{marginBottom: '-20px'}}>Page No.	____________</p>
                        <p style={{marginBottom: '-20px'}}>Book No.	____________</p>
                        <p style={{marginBottom: '-20px'}}>Series of	____________</p>
                    </div>
                </div>
            )}
        </div>
